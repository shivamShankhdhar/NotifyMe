...
<div className="product-info">
  <div className="flex flex-col gap-2">
    <p className="text-[30px] text-secondary font-bold">{product?.currency} {formatNumber(product.currentPrice)}</p>
  ...
  <div className="flex flex-col gap-4">
    ...
    <p className='text-sm text-bold opacity-50'>
...
<div className="flex flex-col gap-16 border-l-black">asd</div>
...
{similarProducts && (
  <div className='py-14 flex flex-col gap-2 w-full'>
    ...
    <div className="flex flex-wrap gap-10 mt-7 w-full">
      {similarProducts && similarProducts.length >0 && similarProducts.map((product:Product) => (
